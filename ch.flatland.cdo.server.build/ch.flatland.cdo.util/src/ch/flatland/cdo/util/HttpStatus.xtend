...
class HttpStatus {
	def getDescription(int httpStatus) {
		switch httpStatus {
			...
			case HttpServletResponse.SC_NOT_ACCEPTABLE: return '''Status code (406) indicating that the resource identified by the content characteristics not acceptable according to the accept headers sent in the request'''
